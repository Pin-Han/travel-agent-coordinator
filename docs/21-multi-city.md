...
目前系統每次只能規劃單一城市。旅行者常見需求是「東京 3 天 → 京都 2 天 → 大阪 2 天」這樣的串聯行程。Phase 21 讓 orchestrator 能識別多城市請求，分段規劃各城市，並加入城市間移動的交通安排。

**先決條件**：Phase 19（三輪對話流程）。
...
| 城市間有簽證問題 | 於 Turn 1 標注（呼叫 Phase 18 Context Agent） |
