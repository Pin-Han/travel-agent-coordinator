...
──────────────                    ────────────────
✅ docs/prompts/*.md              ✅ Evaluator Agent（Phase 10）LLM 打分
...
✅ CLAUDE.md                     ✅ BudgetValidator（Phase 15）
✅ JSON Schema 定義              ✅ GeoSanityCheck（Phase 16）
✅ 修改意圖分類規則（Phase 17）   ✅ PlanConsistencyCheck（Phase 17）
...
|-------|----------|----------|----------|
| **14** 結構化輸出 | 所有後續功能的基礎 | 無 | 立刻 |
| **16** 地圖 + 匯出 | 展示效果最強 | Phase 14 | 接著做 |
| **17** 多輪精煉 | 最重要的產品功能 | Phase 14 | 核心迭代 |
| **15** 預算計算 | 信任感（有數字） | Phase 14 | Phase 17 後 |
| **18** 情境感知 | 真實感（天氣假日） | 無 | 最後 |
